> Archivo histórico anterior a la reparación; contiene afirmaciones y conteos no vigentes.
> Consulte la revisión de corridas del 11 de septiembre, no use esto como protocolo actual.
